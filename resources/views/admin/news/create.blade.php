...
<head>
    ...
    <title>لوحة الأدمن - إضافة خبر</title>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/news/create.css') }}">
</head>
<body>
    <div class="container">
        ...
        <header>
            <div class="header-top">
                <h1><i class="fas fa-newspaper"></i> إضافة خبر جديد</h1>
            ...
            <p>أضف خبراً جديداً ليتم نشره على الموقع</p>
        </header>
            ...
            <div class="form-container">
                ...
                <div class="form-group">
                    ...
                    <textarea name="excerpt" class="form-control" rows="3" 
                              placeholder="أدخل ملخصاً مختصراً للخبر" maxlength="500">{{ old('excerpt') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea name="content" class="form-control" rows="8" 
                              placeholder="أدخل محتوى الخبر الكامل" required>{{ old('content') }}</textarea>
            ...
            <div class="form-container">
                ...
                <div class="file-upload-container" id="fileUploadContainer">
                    <label class="file-upload-label" for="cover_image">
                        ...
                        <small>يُفضل صورة بحجم 1200×630 بكسل (JPG, PNG, GIF)</small>
                    </label>
            ...
            <div class="form-container">
                ...
                <div class="form-group">
                    <div class="checkbox-group">
                        ...
                        <label for="is_published">نشر الخبر مباشرة</label>
                    </div>
                    <small style="color: #666; display: block; margin-top: 8px;">
                        إذا لم تختر هذا الخيار، سيتم حفظ الخبر كمسودة.
                    </small>
                </div>
            </div>
