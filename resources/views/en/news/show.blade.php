@extends('layout.main-shell-en', [
    'title' => 'Al Jawhara Law Firm and Legal Consultancy | ' . $newsItem->title,
...
@push('head')
    ...
    <script type="application/ld+json">
    {
        ...
        "author": {
            "@type": "Person",
            "name": @json($newsItem->author ?? 'Al Jawhara Law Firm and Legal Consultancy')
        },
        "publisher": {
            "@type": "Organization",
            "name": "Al Jawhara Law Firm and Legal Consultancy",
            "logo": {
                "@type": "ImageObject",
        ...
        <div class="news-container">
            ...
            <article class="news-article">
                ...
                <footer class="news-footer">
                    <a href="{{ route('news') }}" class="back-button" aria-label="Back to news page">
                        <i class="fas fa-arrow-right"></i>
                        Back to News
                    </a>

                    <div class="share-buttons" aria-label="Share this news">
                        <a href="https://wa.me/?text={{ urlencode($newsItem->title . ' ' . $canonicalUrl) }}" class="share-button whatsapp" target="_blank" rel="noopener" aria-label="Share on WhatsApp">
                            <i class="fab fa-whatsapp"></i>
                        </a>
                        <a href="https://twitter.com/intent/tweet?text={{ urlencode($newsItem->title) }}&url={{ $canonicalUrl }}" class="share-button twitter" target="_blank" rel="noopener" aria-label="Share on Twitter">
                            <i class="fab fa-twitter"></i>
                        </a>
                        <a href="https://www.facebook.com/sharer/sharer.php?u={{ $canonicalUrl }}" class="share-button facebook" target="_blank" rel="noopener" aria-label="Share on Facebook">
                            <i class="fab fa-facebook-f"></i>
                        </a>
                        <a href="https://www.linkedin.com/sharing/share-offsite/?url={{ $canonicalUrl }}" class="share-button linkedin" target="_blank" rel="noopener" aria-label="Share on LinkedIn">
            ...
            @if(isset($relatedNews) && $relatedNews->count())
                <section class="related-news" aria-label="Related news">
