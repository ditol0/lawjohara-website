@extends('layout.main-shell-ar', [
    'title' => 'الصفحة غير موجودة | مكتب الجوهرة',
    'description' => 'عذرًا، الصفحة المطلوبة غير متوفرة. يمكنك الرجوع للرئيسية أو التواصل معنا.',
    'page' => 'fallback',
...
<section class="fallback-wrap" aria-labelledby="fallbackTitle">
    <div class="container">
        <article class="fallback-card">
            ...
            <h1 id="fallbackTitle">الصفحة غير موجودة</h1>
            <p>
                الرابط الذي حاولت الوصول إليه غير متاح حاليًا، ربما تم نقله أو حذفه أو إدخاله بشكل غير صحيح.
                يمكنك الرجوع للصفحة الرئيسية أو التواصل معنا مباشرة.
            </p>

            <div class="fallback-actions">
                <a href="{{ route('mine') }}" class="button button--primary">العودة إلى الرئيسية</a>
                <a href="{{ route('contact') }}" class="button button--secondary">الذهاب إلى صفحة التواصل</a>
            </div>
        </article>
    </div>
</section>
